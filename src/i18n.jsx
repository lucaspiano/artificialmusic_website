...
const translations = {
  en: {
    ...
    home_cta_sonifya: "See Sonifya",
    home_cta_projects: "Explore projects",
    products: "Products",
    ...
    dissertation_menu_label: "Master Degree Dissertation",
    dissertation_label: "Academic work",
    dissertation_meta: "English • PDF • Full text available",
    dissertation_cta: "Read dissertation",
    dissertation_summary_title: "Dissertation overview",
    dissertation_summary_text: "This work explores how AI can support music generation, emotional sound design, and human-centered interactive systems through research-driven experimentation.",
  ...
  pt: {
    ...
    home_cta_sonifya: "Ver Sonifya",
    home_cta_projects: "Explore projetos",
    products: "Produtos",
    product_sonifya_title: "Sonifya",
    ...
    dissertation_menu_label: "Dissertação de Mestrado",
    dissertation_label: "Trabalho acadêmico",
    dissertation_meta: "Inglês • PDF • Texto completo disponível",
    dissertation_cta: "Ler dissertação",
    dissertation_summary_title: "Resumo da dissertação",
    dissertation_summary_text: "Este trabalho explora como a IA pode apoiar a geração musical, o design sonoro emocional e sistemas interativos centrados no humano por meio de experimentação orientada por pesquisa.",
  ...
  es: {
    ...
    home_cta_sonifya: "Ver Sonifya",
    home_cta_projects: "Explorar proyectos",
    products: "Productos",
    product_sonifya_title: "Sonifya",
    ...
    dissertation_menu_label: "Disertación de Maestría",
    dissertation_label: "Trabajo académico",
    dissertation_meta: "Inglés • PDF • Texto completo disponible",
    dissertation_cta: "Leer disertación",
    dissertation_summary_title: "Resumen de la disertación",
    dissertation_summary_text: "Este trabajo explora cómo la IA puede apoyar la generación musical, el diseño sonoro emocional y los sistemas interactivos centrados en el ser humano mediante experimentación guiada por la investigación.",
